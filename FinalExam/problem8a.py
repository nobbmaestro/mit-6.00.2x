...
def foxGrowth():
    ...
    # TO DO
    pop = CURRENTFOXPOP
    for fox in range(pop):
        if CURRENTRABBITPOP > 10:
            prob = CURRENTRABBITPOP / MAXRABBITPOP
        else:
            prob = 0
        if prob*100 > random.randint(0, 100) and 30 > random.randint(0, 100):
            CURRENTFOXPOP += 1
            CURRENTRABBITPOP -= 1

        elif CURRENTRABBITPOP > 10 and 90 > random.randint(0, 100):
            CURRENTFOXPOP -= 1

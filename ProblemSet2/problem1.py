...
#   - Position: We've also provided a complete implementation of this class. It stores the x- and y-coordinates of a robot in 
#     a room.
#
...
from ProblemSet2 import Position
...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        self.width = width
        self.heigth = height
        self.isCleaned = [[False for w in range(self.width)] for h in range(self.heigth)]
    ...
    def cleanTileAtPosition(self, pos):
        ...
        """
        try:
            self.isCleaned[int(pos.getY())][int(pos.getX())] = True
        except IndexError:
            self.isCleaned[int(pos.getX())] = True
    ...
    def isTileCleaned(self, m, n):
        ...
        """
        try:
            if self.isCleaned[n][m] == True:
                return True
            else:
                return False
        except IndexError:
            if self.isCleaned[m] == True:
                return True
            else:
                return False
    ...
    def getNumTiles(self):
        ...
        returns: an integer
        """
        return len(self.isCleaned) * len(self.isCleaned[0])
    ...
    def getNumCleanedTiles(self):
        ...
        """
        cleanTiles = 0
        for h in range(len(self.isCleaned)):
            for w in range(len(self.isCleaned[h])):
                if self.isCleaned[h][w] == True:
                    cleanTiles += 1
    ...
    def isPositionInRoom(self, pos):
        ...
        """
        if 0 <= pos.getX() and pos.getX() < self.width and 0 <= pos.getY() and pos.getY() < self.heigth:
            return True
        else:
            return False
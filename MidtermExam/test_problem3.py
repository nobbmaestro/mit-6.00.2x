...
from MidtermExam import greedy_sum as func
...
class TestProblem3(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_data = {
            ...
            6: {
                'input': [[15, 12, 4, 3, 1], 29],
                'output': 4
            },
            7: {
                'input': [[16, 12, 5, 3, 1], 15],
                'output': 2
            },
            8: {
                'input': [[16, 12, 5, 3, 1], 24],
                'output': 3
            },
            9: {
                'input': [[10, 8, 5, 2], 16],
            ...
            11: {
                'input': [[11, 10, 8, 5, 1], 16],
                'output': 2
            },
            12: {
                'input': [[12, 10, 8, 5, 2], 17],
                'output': 2
            },
            13: {
                'input': [[20, 10, 4, 3, 1], 21],
                'output': 2
            },
            14: {
                'input': [[21, 10, 8, 3, 1], 11],
                'output': 2
            },
            15: {
                'input': [[30, 20, 10], 60],

...
def generate_models(x, y, degs):
    """Generate regression models by fitting a polynomial for each degree in degs to points (x, y).

    Args:
        x (list): a list with length N, representing the x-coords of N sample points
        y (list): a list with length N, representing the y-coords of N sample points
        degs (int): a list of degrees of the fitting polynomial

    Returns:
        list: a list of numpy arrays, where each array is a 1-d array of coefficients
